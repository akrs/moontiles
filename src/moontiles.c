...
void handle_init()
{
	...
	day_text = init_text(8, 83 + 2, 68, 43 - 2, RESOURCE_ID_FONT_WW_DIGITAL_DOW_SUBSET_28, COLOR_BACKGROUND);
	date_text = init_text(65, 128 + 2, 32, 32 - 2, RESOURCE_ID_FONT_WW_DIGITAL_DATE_SUBSET_24,COLOR_BACKGROUND);
	month_text = init_text(0, 128 + 2, 68, 32 - 2, RESOURCE_ID_FONT_WW_DIGITAL_DATE_SUBSET_24,COLOR_BACKGROUND);
	year_text= init_text(110, 128 + 2, 32, 32 - 2, RESOURCE_ID_FONT_WW_DIGITAL_DATE_SUBSET_24,COLOR_BACKGROUND);
